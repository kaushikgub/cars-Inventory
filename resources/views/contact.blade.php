...
<body>
	...
	<div class="col-lg-7 mexico-contact">
      ...
      <div class="form-group required" data-type="text" data-required="true">
      <input type="email" class="form-control" placeholder="Your Email Address" name="email1">
      </div> 
      <div class="form-group required" data-type="text" data-required="true">
      <input type="text" class="form-control" placeholder="Subject" name="subject1">
      </div> 
      <div class="form-group required" data-type="text" data-required="true">
      <textarea id="text" class="form-control" placeholder="How can I help you?" name="help1"></textarea>
      </div> 
