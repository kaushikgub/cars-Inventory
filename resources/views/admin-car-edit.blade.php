                ...
                <div class="col-lg-12 mexico-nav">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a class="" href="{{ asset('admin-panel/car-upload') }}">Car-Upload</a>
                            </li>
                            <li>
                        ...
                        <div class="col-lg-12 mexico-upload3">
                            ...
                            <div class="form-group" data-type="text">
                                ...
                                <select class="select_box" name="has_registration" required>
                                    <option value="{{$car->has_registration}}">{{$car->has_registration}}</option>
                            ...
                            <div class="form-group" data-type="text">
                                ...
                                <select class="select_box" name="condition" required>
                                    <option value="{{ $car->condition }}">{{ $car->condition }}</option>
                            ...
                            <div class="form-group " data-type="text" data-="true">
                                ...
                                <input type="number" class="form-control" name="cylinders" value="{{ $car->cylinders }}" required>
                            </div>
                            <div class="form-group " data-type="text" data-="true">
                    ...
                    <div class="col-lg-12 mexico-upload-wrap2">
                        ...
                        <div class="col-lg-12 mexico-license3">
                            <div class="col-lg-3 mexico-license4">
                                <input type="file" accept="image/*" name="image_1" id="image_1" style="opacity: 0; height: 130px; width: 200px; cursor: pointer">
                                <img style="margin-top: -156px" src="{{ asset('images/mexico-img3.png') }}" alt="img3">
                            </div>
                            <!--col-lg-3-->
                            <div class="col-lg-3 mexico-license5">
                                <img id="p_image_1" style="height: 13rem; width: 20rem" src="{{ asset('storage') }}/{{ $car->image_1 }}" alt="img4">
                            </div>
                            <!--col-lg-3-->
                        </div>
                        <!--col-lg-12-->
...
{{--                            </div>--}}
                            ...
                            <div class="col-lg-4 mexico-license5">
                                <input type="file" accept="image/*" name="image_2" id="image_2" style="opacity: 0; height: 130px; width: 200px; cursor: pointer">
                                <img id="p_image_2" style="margin-top: -156px; height: 13rem; width: 20rem" src="{{ asset('storage') }}/{{ $car->image_1 }}" alt="img3">
                            </div>
                            <!--col-lg-3-->
                            <div class="col-lg-4 mexico-license5">
                                <input type="file" accept="image/*" name="image_3" id="image_3" style="opacity: 0; height: 130px; width: 200px; cursor: pointer">
                                <img id="p_image_3" style="margin-top: -156px; height: 13rem; width: 20rem" src="{{ asset('storage') }}/{{ $car->image_2 }}" alt="img3">
                            </div>
                            <!--col-lg-3-->
                            <div class="col-lg-4 mexico-license5">
                                <input type="file" accept="image/*" name="image_4" id="image_4" style="opacity: 0; height: 130px; width: 200px; cursor: pointer">
                                <img id="p_image_4" style="margin-top: -156px; height: 13rem; width: 20rem" src="{{ asset('storage') }}/{{ $car->image_3 }}" alt="img3">
                            </div>
                            <!--col-lg-3-->
                        </div>
                        <!--col-lg-12-->
...
<script language="JavaScript" type="text/javascript">
    ...
    $(document).on('submit', '#car_form', function () {
        ...
        $.ajax({
            method: 'post',
            data: formData,
            url: '{{ url('admin-panel/car-update') }}',
            contentType: false,
            processData: false,
            cache: false,
            success: function (result) {
                console.log(result);
                if (result === 'Car update successfully'){
